  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.room.toTitleCase(),style: TextStyle(color: Color(0xffDBE6FC)),),
                      ...
                      children: <Widget>[
                        ...
                        MaterialButton(
                          onPressed: () {
                            ...
                            _firestore.collection(widget.room).add({
                              'text': textMessage,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Material(
            elevation: 5.0,
            borderRadius: sameLastSender? BorderRadius.circular(30)  :   isMe
                ? BorderRadius.only(
